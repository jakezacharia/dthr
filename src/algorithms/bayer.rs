// precomputed bayer matrices
// will add the ability to calculate n matrix size later, this works for now!
    const B2: [[u8; 2]; 2] = [[0, 2], [3, 1]];

    const B4: [[u8; 4]; 4] = [[0, 8, 2, 10],
                        [12, 4, 14, 6],
                        [3, 11, 1, 9],
                        [15, 7, 13, 5]];
